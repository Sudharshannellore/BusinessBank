...
<body>
	...
	<main>
    <div id="con4">
      <form id="form1" action="/tranferamount/${detail.id}" method="post">
        <div class="group">
          <label class="label1">AccountId :</label>
          <input class="in" type="text" name="tid" placeholder="Enter AccountId"/>
        </div>
         <div class="group">
          <label class="label1">Amount :</label>
          <input class="in" type="text" name="amount" placeholder="Enter Amount"/>
        </div>
               <div class="group">
